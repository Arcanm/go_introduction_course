...
func main() {
	// His WaitGroup is used to wait for all the goroutines launched here to finish.
	...
	for i := 1; i <= 5; i++ {
		...
		// that this worker is done. This way the worker itself does not have to be aware
